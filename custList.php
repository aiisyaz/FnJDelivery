                ...
                <div class="col-lg mb-4 order-0">
                  ...
                  <div class="card">
                    ...
                    <?php
                      ...
                      $select_customer = $conn->query($query);
                      if ($select_customer) {

                          while ($fetch_customer = $select_customer->fetch_assoc()){
                              $_SESSION['cust_id'] = $fetch_customer['CUSTOMERID']; 
                    ?> 
                    <!-- <box-icon name='plus'></box-icon> -->
                    
                              <tr>
                                <td><?php echo $fetch_customer['CUSTOMERID']; ?></td>
                                <td><i class="fab fa-bootstrap fa-lg text-primary me-3"></i><strong><?php echo $fetch_customer['CUSTOMERNAME']; ?></strong></td>
                                <td><?php echo $fetch_customer['CUSTOMERPHONENUMBER']; ?></td>
                                <td><?php echo $fetch_customer['CUSTOMEREMAIL']; ?></td>
