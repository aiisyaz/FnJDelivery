<?php
    ...
    $select_rider = mysqli_query($conn, "SELECT * FROM STAFF WHERE STAFFROLE='RIDER' AND STAFFSTATUS='ACTIVE'");
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="row">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="riderSchedule.php"><i class="bx bx-pie-chart-alt me-1"></i> In Coming</a>
                    </li>
                    <li class="nav-item">
                      <a class="btn btn-outline-secondary" href="scheduleInProgress.php"
                    ...
                    <li class="nav-item">
                      ...
                      <?php endif; ?>
                        <!-- Bordered Table -->
                        <div class="card">
                        <h5 class="card-header"><span class="text-muted fw-light">F&J Service Management / Manage Status / </span> In Coming</h5>
                            <div class="card-body">
                                      ...
                                      ?>                                         
                                        <tbody>
                                          <tr>
                                            ...
                                            <td>
                                              <a data-bs-toggle="modal" data-bs-target="#modalRider" class="btn btn-primary"><i name = "edit" class="bx bx-edit-alt me-1"></i> Edit</a>
                                                <!-- Modal 2 -->
                                              <div class="modal fade" id="modalRider" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="modalCenterTitle"><strong>Assign Rider</strong></h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                      ...
                                                      <div class="modal-body">
                                                        <div class="row">
                                                          <div class="mb">
                                                            ...
                                                            <div class="col-md-10">
                                                              <input type="hidden" name="track_id" value="<?php echo $fetch_service['TRACKID']; ?>" id="html5-text-input">
                                                              <input type="hidden" name="track_status" value="IN PROGRESS" id="html5-text-input">
                                                              <select class="form-select" id="exampleFormControlSelect1" name="rider_id">
                                                              
                                                                <option value="<?php echo $fetch_service['STAFFID']; ?>">
                                                                <?php echo $fetch_service['STAFFNAME']; ?>
                                                                </option>
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($select_rider)) {
                                                                    ...
                                                                    if ($row['STAFFNAME'] !== $fetch_service['STAFFNAME']) {
