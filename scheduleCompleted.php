          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="row">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="scheduleCancelled.php"
                      ...
                      <?php endif; ?>
                        <!-- Bordered Table -->
                        <div class="card">
                        <h5 class="card-header"><span class="text-muted fw-light">F&J Service Management / Manage Status / </span>Completed </h5>
                            <div class="card-body">
                                    ...
                                    <form method='POST'>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            $query = "SELECT DISTINCT T.TRACKID, S.SERVICEID, C.CUSTOMERID, C.CUSTOMERNAME, SD.SERVICEDETAILSLOCATION, S.SERVICENAME,SD.SERVICEDETAILSID, 
                                                    ...
                                                    WHERE t.TRACKSTATUS = 'ARRIVED AT THE STORE' 
