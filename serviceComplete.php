...
<body class="is-preload">
	...
	<!-- Main -->
              ...
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tracking Service / Completed</span> </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="serviceComplete.php"
                    ...
                    <form method='POST' action="">
                        ...
                        WHERE 
                            (t.TRACKSTATUS = 'COMPLETED' OR t.TRACKSTATUS = 'ARRIVED AT THE STORE') AND sd.CUSTOMERID = '$cust_id'";
                                    ...
                                    <td>
                                        ...
                                        <a type= "button" class ="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalStatus<?php echo $fetch_service['SERVICEDETAILSID']; ?>">Details</a>
                                            ...
                                            <?php
                                                ...
                                                WHERE
                                                    sd.SERVICEDETAILSID = '$service_id'";
