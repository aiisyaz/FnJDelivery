...
<body class="is-preload">
	...
	<!-- Main -->
              ...
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tracking Service / In Coming</span> </h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="serviceInComing.php"><i class="bx bx-pie-chart-alt me-1"></i> In Coming</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="btn btn-outline-secondary" href="serviceCancelled.php"
                    ...
                    <form method='POST' action="process-cancelService.php">
                        ...
                        WHERE 
                            t.TRACKSTATUS = 'PENDING' AND sd.CUSTOMERID = '$cust_id'";
                            ...
                            <div class="card-body">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a type="button" class ="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editServiceModal" onclick="getService('<?php echo $fetch_service['SERVICEDETAILSID']; ?>')">Edit</a>
                                        <a href="process-cancelService.php?SERVICE_ID=<?php echo $fetch_service['SERVICEDETAILSID']; ?>" type="button" class ="btn btn-primary" name="cancel" onclick="return confirm('Are you sure you want to cancel this service?')">Cancel Service</a>
        ...
        <script>
            ...
            xhr.onreadystatechange = function () {
                ...
                if (xhr.status == 200) {
                    ...
                    '?SERVICEDETAILSID=' + encodeURIComponent(serviceData.SERVICEDETAILSID) +
                    '&CUSTOMERNAME=' + encodeURIComponent(serviceData.CUSTOMERNAME) +
                    '&SERVICENAME=' + encodeURIComponent(serviceData.SERVICENAME) +
                    '&SERVICEDETAILSLOCATION=' + encodeURIComponent(serviceData.SERVICEDETAILSLOCATION) +
