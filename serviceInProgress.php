	...
	<div id="main">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tracking Service / In Progress</span> </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="serviceInProgress.php"
                                ...
                                <td>
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT DISTINCT 
                                                d.DEVICEID, d.DEVICEDESC, d.DEVICETYPE, d.DEVICENAME
                                            FROM 
                                                SERVICEDB.SERVICE s
                                            JOIN 
                                                SERVICEDB.SERVICEDETAILS sd ON s.SERVICEID = sd.SERVICEID
                                            JOIN 
                                                SERVICEDB.SERVICEDETAILSDEVICE sdv ON sd.SERVICEDETAILSID = sdv.SERVICEDETAILSID
                                            JOIN 
                                                SERVICEDB.DEVICE d ON sdv.DEVICEID = d.DEVICEID 
                                            WHERE 
                                    ...
                                    <div class="modal fade" id="modalStatus<?php echo $service_id; ?>" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="mb">
                                                        <h4 class="modal-title"><?php echo $fetch_service['SERVICENAME']; ?></h4>
                                                        <table>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td><i class=""></i> <strong>Rider Name</strong> </td>
                                                                <td><?php echo $fetch_service['STAFFNAME']; ?></td>
                                                            <tr>
                                                                <td><i class=""></i> <strong>Rider Phone Number</strong> </td>
                                                                <td><?php echo $fetch_service['STAFFPHONENUM']; ?></td>
                                                            </tr>
                                                            <tr>
