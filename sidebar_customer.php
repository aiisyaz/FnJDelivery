      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="createRequest.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Layouts">Create Request</div>
              </a>
            </li>

            <!-- customer management-->
            <li class="menu-item">
              <a href="view_device.php" class="menu-link">
                <i class="menu-icon bx bx-layout"></i>
                <div data-i18n="Layouts">My Device</div>
              </a>
            </li>
    
	      <!-- customer management-->
            <li class="menu-item">
              <a href="serviceInComing.php" class="menu-link">
                <i class="menu-icon bx bx-layout"></i>
                <div data-i18n="Layouts">Status Tracking</div>
              </a>
            </li>
			
	    <!-- rider management-->
            <li class="menu-item">
              <a href="showProfile.php" class="menu-link">
                <i class="menu-icon bx bx-layout"></i>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?php echo $cust_name; ?></span>
                            <small class="text-muted"><?php echo $cust_id; ?></small>
                          </div>
                        </div>
                      </a>
                    </li>
